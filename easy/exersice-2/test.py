...
import unittest
from app import alphabet_position

class TestCases(unittest.TestCase):
    
    def test_function(self):
        self.assertEqual(alphabet_position("gullible"), "7 21 12 12 9 2 12 5")
        self.assertEqual(alphabet_position("transfer"), "20 18 1 14 19 6 5 18")
        self.assertEqual(alphabet_position("advertisement"), "1 4 22 5 18 20 9 19 5 13 5 14 20")
